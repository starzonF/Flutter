...
import 'package:flutter_2/pages/detail_pages.dart';
import 'package:flutter_2/widgets/poke_image_and_ball.dart';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Chip(label: Text(pokemon.type![0],style: Constants.getPokemonChipTextStyle(),)),
